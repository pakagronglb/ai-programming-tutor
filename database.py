...
class Database:
    def __init__(self):
        ...
        self.client = MongoClient(
            f"mongodb+srv://{os.getenv('MONGO_USER')}:{os.getenv('MONGO_PWD')}@database.0o8ty.mongodb.net/?retryWrites=true&w=majority",
            tlsCAFile=certifi.where()  # Add this line to fix SSL issues
        )
        self.db = self.client.ai_tutor  # or whatever your database name is
